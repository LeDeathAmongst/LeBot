...
class CoreLogic:
    ...
    async def _version_info(cls) -> Dict[str, str]:
        ...
        """
        return {"LeBot": __version__, "discordpy": discord.__version__}
...
class Core(commands.commands._RuleDropper, commands.Cog, CoreLogic):
    ...
    async def uptime(self, ctx: commands.Context):
        ...
        delta = discord.utils.utcnow() - uptime
    ...
    async def dm(self, ctx: commands.Context, user: discord.User, *, message: str):
        ...
        **Arguments:**
        ...
        e.set_author(name=description, icon_url=ctx.me.display_avatar.url)
        try:
